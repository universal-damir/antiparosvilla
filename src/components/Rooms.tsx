    ...
    <section className="bg-[#F4F3EB] w-full pt-28 md:pt-32">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-8 text-center">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-[#3A3532] font-['American_Typewriter'] leading-relaxed text-base mb-6">
          ...
          <p className="text-[#3A3532] font-['American_Typewriter'] leading-relaxed text-base">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-20">
        {roomData.map((room) => (
          <div key={room.id} className="mb-24 bg-white">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-12">
                <h3 className="text-2xl font-['American_Typewriter'] text-black uppercase font-bold tracking-wide mb-6">
                  {room.name}
                </h3>
                ...
                <p className="text-black font-['American_Typewriter'] leading-relaxed text-base">
                  {room.description}
                </p>
